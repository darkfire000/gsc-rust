...
ARG server_id=chilling
ENV SERVER_ID=${server_id}

ADD run.sh /home/rust/rustserver/run.sh
ADD bans.cfg /home/rust/rustserver/server/${server_id}/cfg/bans.cfg
ADD server.cfg /home/rust/rustserver/server/${server_id}/cfg/server.cfg
ADD users.cfg /home/rust/rustserver/server/${server_id}/cfg/users.cfg
